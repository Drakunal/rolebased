							...
							<div class="card">
								...
								<div class="card-body">
									<form enctype="multipart/form-data" method="post" action="">
                                        ...
                                        <div class="mb-3">
                                        <label class="form-label">Anställd Namn<span style="color:red">*</span></label>
                                            <?php 
									        	$role="employee";
										...
										<div class="mb-3">
											<label class="form-label">Start datum<span style="color:red">*</span></label>
											<input type="date" required  name="start-date"class="form-control" placeholder="datum">
										</div>
                                        <div class="mb-3">
											<label class="form-label">Slutdatum<span style="color:red">*</span></label>

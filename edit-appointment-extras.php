                                    ...
                                    <form enctype="multipart/form-data" method="post" action="">
                                        <div class="mb-3 col-md-2">
                                            ...
                                            <?php if ($row77['additional_charge'] != 0.00) {
                                                ...
                                                <input type="number" required step="0.01" name="additional_charge" class="form-control" value="<?php echo $additional_charge; ?>">
                                            <?php } else { ?>
                                                <input type="number" value=0.00 step="0.01" name="additional_charge" class="form-control" placeholder="Extra avgifter">
                                            <?php } ?>
                                        </div>
                                        <div class="mb-3 col-md-2">
                                            ...
                                            <?php if ($row77['invoice_charge'] != 0.00) {
                                                ...
                                                <input type="number" required step="0.01" name="invoice_charge" class="form-control"  value="<?php echo $invoice_charge; ?>">
                                            <?php } else { ?>
                                                <input type="number" value=0.00 step="0.01" name="invoice_charge" class="form-control" placeholder="Fakturakostnader">
                                            <?php } ?>

						...
						<div class="">
							<div class="card">
								<div class="card-header">
									...
									<h6 class="card-subtitle text-muted">Redigera dina cusotmers här.</h6>
								</div>
								<div class="card-body">
									<form enctype="multipart/form-data" method="post" action="">
										<div class="mb-3">
											<label class="form-label">Kundnummer</label>
											<input type="text" name="email" class="form-control" placeholder="Kundnummer" value="<?php echo $res['user_id'] ?>">
										</div>
										<div class="mb-3">

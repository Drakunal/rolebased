		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					$role1 = 'customer';
					$customer_list_query = mysqli_query($db, "SELECT id,name from `users` where role='$role1' AND deleted_at is NULL;") or die("Unsuccessful");
					// $customer_list_row= $customer_list_query->fetch_assoc();
			...
			?>
				...
				<?php
							...
							// 		mysqli_query($db, "INSERT INTO `appointments` (customer_id, employee_id, date, time,time_alloted,base_price) VALUES('$customer_id','$employee_id', '$date','$time','$time_alloted','$base_price');") or die("Unsuccessful");
							// 	$customer_user_id = mysqli_query($db, "SELECT name,user_id from `users` where id=$customer_id;"); 
				?><?php

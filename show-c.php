                                             ...
                                             if($color=="red"){
												...
												<tbody>
													...
													<!-- <div style='float:left'>
                                                        ...
                                                        <a style='color:white;text-decoration: none;' href='holiday-delete.php?id=<?php
                                                        // echo $event_id;
                                                        ?>'>Cancel Holiday</a>
                                                        </button></div> -->
																					...
																					<div class="card-body">
																						...
																						$pos = strpos($time_alloted, '.');
																							...
																							<!-- <div style='float:left'>
																									<button class='btn btn-primary'>
																									<i class='fa fa-question'></i>
																									<a style='color:white;text-decoration: none;' href='appointment-reschedule.php?id=<?php 
                                                                                                    //echo $appointment_id;?>'>Reschedule</a>
																									
																									</button>
																									<button class='btn btn-primary'>
																									<i class='fa fa-question'></i>
																									<a style='color:white;text-decoration: none;' href='employee-change.php?id=<?php 
                                                                                                    //echo $appointment_id;?>'>Change Employee for All</a>
																									...
																									<button class='btn btn-danger' >
																									<i class='fas fa-times'></i> 
																									<a style='color:white;text-decoration: none;' href='appointment-delete.php?id=<?php 
                                                                                                    //echo $appointment_id;?>'>Cancel</a>
																									</button></div> -->

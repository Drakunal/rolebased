				...
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3">Add Customer Appointment</h1>
						<?php
                            ...
                            $qq=mysqli_query($db,"SELECT id from `notification` where customer_id='$customer_id' and seen_at is NULL;")or die("notification seen");
                            $notification_row=$qq->fetch_assoc();
                            $notification_id=$notification_row['id'];
                            mysqli_query($db,"UPDATE `notification` SET customer_id=5 where id='$notification_id';");
							...
							<div class="card">
								...
								<div class="card-body">
									<form enctype="multipart/form-data" method="post" action="">
										<label class="form-label">Employee<span style="color:red">*</span><?php echo $notification_id;?></label>

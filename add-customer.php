          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Lägg till kundformulär</h1>
						...
						<div class="">
							<div class="card">
								<div class="card-header">
									...
									<h6 class="card-subtitle text-muted">Lägg till dina kunder här.</h6>
								</div>
								<div class="card-body">
									<form enctype="multipart/form-data" method="post" action="">
										<div class="mb-3">
											<label class="form-label">Kundnummer<span style="color:red">*</span></label>
											<input type="text" required name="email" class="form-control" placeholder="Kundnummer">
										</div>
										<div class="mb-3">

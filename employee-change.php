		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Byt anställd permanent</h1>
										...
										?> <form method="POST">
											<thead>
												<tr>
													...
													<th style="width:25%">Anställd<span style="color:red">*</span></th>
							...
							<div class="card">
								<div class="col-md-12">
									<div class="card">
										<div class="card-body">
											...
											<div style='float:left'>
												<button class='btn btn-success' type="submit" name="submit">
													...
													<a style='color:white;text-decoration: none;'>Spara ändringar</a>
												</button>
											</div>
											</form>
										</div>
										...
										?><script>
												console.log("<?php echo $customer_id; ?>")
											</script>
											<?php
